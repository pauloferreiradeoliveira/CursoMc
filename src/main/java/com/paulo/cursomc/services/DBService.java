...
public class DBService {
	...
	public void instantiateTestDatabase() throws ParseException {
		...
		Produto p43 = new Produto(null, "Produto 43", 90.00);
		Produto p44 = new Produto(null, "Produto 44", 80.00);
		Produto p45 = new Produto(null, "Produto 45", 70.00);
		Produto p46 = new Produto(null, "Produto 46", 60.00);
		Produto p47 = new Produto(null, "Produto 47", 50.00);
		Produto p48 = new Produto(null, "Produto 48", 40.00);
		Produto p49 = new Produto(null, "Produto 49", 30.00);
		Produto p50 = new Produto(null, "Produto 50", 20.00);
		
		cat1.getProdutos().addAll(Arrays.asList(p1,p2,p3));
		cat2.getProdutos().addAll(Arrays.asList(p2,p4,p41));
		cat3.getProdutos().addAll(Arrays.asList(p5,p6,p12));
		cat4.getProdutos().addAll(Arrays.asList(p1,p2,p3,p7));
		cat5.getProdutos().addAll(Arrays.asList(p8,p47));
		...
		p41.getCategorias().addAll(Arrays.asList(cat1,cat2));
		p42.getCategorias().add(cat1);
		p43.getCategorias().add(cat1);
		p44.getCategorias().add(cat1);
		p45.getCategorias().add(cat1);
		p46.getCategorias().add(cat1);
		p47.getCategorias().addAll(Arrays.asList(cat1,cat5));
		...
		produtoReposity.saveAll(Arrays.asList(p12, p13, p14, p15, p16, p17, p18, p19, p20,
